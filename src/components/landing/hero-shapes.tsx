  ...
  return (
    <div className="relative w-full h-full min-h-[500px]">
      ...
      <FloatingShape className="top-[15%] left-[20%] z-10" delay={0} duration={7}>
        <div className="w-28 h-36 rounded-2xl bg-[#f472b6] shadow-xl relative overflow-hidden">
        </div>
      </FloatingShape>
      ...
      <FloatingShape className="top-[0%] right-[5%] z-10" delay={1} duration={8}>
        <div className="w-16 h-16 rounded-full bg-[#8b5cf6] shadow-lg relative overflow-hidden">
      ...
      <FloatingShape className="top-[40%] left-[10%] z-20" delay={0.8} duration={7} y={12}>
        <div
          className="w-20 h-20 bg-[#fda4af] shadow-xl relative"
      ...
      <FloatingShape className="top-[35%] right-[10%] z-10" delay={1.5} duration={5} y={20}>
        <div className="w-10 h-10 rounded-full bg-[#f9a8d4] shadow-md" />
      </FloatingShape>

      {/* Striped sphere bottom */}
      <FloatingShape className="bottom-[15%] right-[15%] z-20" delay={0.3} duration={7} y={12}>
        <div className="w-14 h-14 rounded-full bg-[#8b5cf6] shadow-lg relative overflow-hidden">
      ...
      <motion.div
        className="absolute -top-10 -right-10 w-[300px] h-[3px] bg-violet-400/50 rounded-full z-0"
        style={{ transform: "rotate(-55deg)", transformOrigin: "right top" }}
        animate={{ opacity: [0.4, 0.7, 0.4] }}
        transition={{ duration: 4, repeat: Infinity }}
      />
      <motion.div
        className="absolute top-[10%] -right-5 w-[250px] h-[2px] bg-violet-500/50 rounded-full z-0"
        style={{ transform: "rotate(-55deg)", transformOrigin: "right top" }}
        animate={{ opacity: [0.3, 0.6, 0.3] }}
        transition={{ duration: 5, repeat: Infinity, delay: 1 }}
      />
      <motion.div
        className="absolute top-[20%] right-[10%] w-[200px] h-[2px] bg-violet-400/50 rounded-full z-0"
        style={{ transform: "rotate(-55deg)" }}
        animate={{ opacity: [0.5, 0.8, 0.5] }}
        transition={{ duration: 3.5, repeat: Infinity, delay: 0.5 }}
      />
      <motion.div
        className="absolute top-[5%] right-[25%] w-[180px] h-[3px] bg-violet-500/50 rounded-full z-0"
        style={{ transform: "rotate(-55deg)" }}
        animate={{ opacity: [0.3, 0.5, 0.3] }}
        transition={{ duration: 6, repeat: Infinity, delay: 2 }}
      />
      <motion.div
        className="absolute top-[15%] right-[5%] w-[150px] h-[2px] bg-violet-300/50 rounded-full z-0"
        style={{ transform: "rotate(-55deg)" }}
